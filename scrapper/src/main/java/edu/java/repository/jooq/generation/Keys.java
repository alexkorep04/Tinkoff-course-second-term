...
package edu.java.repository.jooq.generation;


import edu.java.repository.jooq.generation.tables.Chat;
import edu.java.repository.jooq.generation.tables.ChatLink;
import edu.java.repository.jooq.generation.tables.Link;
import edu.java.repository.jooq.generation.tables.records.ChatLinkRecord;
import edu.java.repository.jooq.generation.tables.records.ChatRecord;
...
public class Keys {
    ...
    public static final ForeignKey<ChatLinkRecord, LinkRecord> CONSTRAINT_86 = Internal.createForeignKey(ChatLink.CHAT_LINK, DSL.name("CONSTRAINT_86"), new TableField[] { ChatLink.CHAT_LINK.LINK_ID }, Keys.CONSTRAINT_2, new TableField[] { Link.LINK.LINK_ID }, true);
}
