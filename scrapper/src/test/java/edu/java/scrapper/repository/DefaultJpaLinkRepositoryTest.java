...
public class DefaultJpaLinkRepositoryTest extends IntegrationTest {
    private final DefaultJpaLinkRepository linkRepository;
    private final DefaultJpaChatRepository chatRepository;
    @Autowired
    public DefaultJpaLinkRepositoryTest(JpaLinkRepository jpaLinkRepository, JpaChatRepository jpaChatRepository) {
        linkRepository = new DefaultJpaLinkRepository(jpaLinkRepository);
    ...
    public void testFindByChatIdAndUrl() {
        ...
        Optional<Link>
            link = linkRepository.findByChatIdAndUrl(1L, "https://github.com/alexkorep04/Tinkoff-course-second-term");
